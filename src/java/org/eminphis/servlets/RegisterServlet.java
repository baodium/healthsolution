...
public class RegisterServlet extends HttpServlet{
    ...
    protected void doPost(HttpServletRequest request,HttpServletResponse response)
        ...
        try{
             ...
             * +"</body>");
             */
            String message="<h2>Patient details was inserted successfully.</h2>"
                    +"<body>"
                    +"Autogenerated hospital number: "
                    +"<b>"
                    +"<font size=20>"
                    ...
                    +"</b>"
                    +"</body>";
            registrationManager.showSuccessPage(message);
        } catch(IOException ex){
            ErrorLogger.logError(ex);
            registrationManager.showErrorPage("An error occurred while fulfilling your request to add this patient.",ex);
