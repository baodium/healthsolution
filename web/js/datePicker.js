...
$(function(){
    ...
    $("#diag_date").click(function(){
        new datepickr('diag_date');
                                                       
    });
    $('#op_date').click(function(){

        new datepickr('op_date');
    });
    
    $("#disc_date").click(function(){
        new datepickr('disc_date');
                                                       
    });
   
    $("#appt_date").click(function(){
        new datepickr('appt_date');
                                                       
    });
    $("#sel_date").click(function(){
        new datepickr('sel_date');
...
var datepickr = (function() {
    ...
    function buildCurrentMonth(config, currentMonthView, currentYearView) {
        ...
        }, date.month.string(config.fullCurrentMonth, currentMonthView) + ' ' + currentYearView);
    }
    ...
    function buildCalendar() {
        ...
        //the first click
        //change the display to hidden if you want to call the function on load of the documen
        //it changes to show on consequent click
        calendarContainer.style.cssText = 'display: block; position: absolute; top: ' + (inputTop + this.element.offsetHeight) + 'px; left: ' + inputLeft + 'px; z-index: 100;';
