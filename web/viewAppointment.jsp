      ...
      <div class="section group">
        <div class="col span_1_of_3">
          <div class="contact_info">
              <h3><img src="images/consulltant.png">&nbsp;<span class="a_m appt_menu activeSub" name="apt_consultant">Consultant</span></h3>
          </div>
          <div class="contact_info">
              <h3><img src="images/clinic.png">&nbsp;<span class="a_m appt_menu" name="apt_clinic">Clinic</span></h3>
          </div>
          <div class="apt_menu apt_date">
              <h3><img src="images/date.png">&nbsp;<span class="a_m appt_menu" name ="apt_date">Date</span></h3>
          </div>
            
            <br/><br/>
            
            <div class="contact_info">
              <a href="appointment.jsp"><h3><img src="images/sch_apt.png">&nbsp;<span class="a_m activeSub">SCHEDULE</span></h3></a>
          </div>
        </div>
        <div class="col span_2_of_3">
          <div class="contact-form">
          <div class="item2 selected apt_consultant">
        ...
        </div> <!-- END OF CLINIC APPOINTMENT -->
        
        <div class="item2 apt_date">
 <h3> 23/15/2012 </h3>
                <table>
                <tr>
                <td>Schedule: &nbsp;&nbsp;</td><td>Schedule infor</td>
                </tr>
                                <tr>
                <td>Schedule: &nbsp;&nbsp;</td><td>Schedule infor</td>
                </tr>
