		...
		<!---start-wrap---->
			...
			<div class="header">
					...
					<div class="main-header">
						<div class="wrap">
							<div class="logo">
								<a href="index.jsp"><img src="images/minLogo.png" title="logo" /></a>
							</div>
					...
					<div class="top-nav">
						<div class="wrap">
							<ul>
								...
								<li><a href="#">Module #</a></li>
								<li><a href="#">Module #</a></li>
                                 <li><a href="register.jsp">Registration Module</a></li>
								<li><a href="#">Module #</a></li>
								<div class="clear"> </div>
							</ul>
						</div>
					    ...
					    <ul class="rslides rslides1" id="slider1" style="max-width: 2500px;">
					      <li id="rslides1_s0" class="" style="display: block; float: none; position: absolute; opacity: 0; z-index: 1; -webkit-transition: opacity 600ms ease-in-out; transition: opacity 600ms ease-in-out;">
					      	...
					      	<div class="slider-info">
					      		<p>&nbsp;&nbsp;eMINPHIS the best Hospital WEB PORTAL</p>
					      		<span>Made In Nigeria Primary Hospital Information System. </span>
					      		<a href="#">ReadMore</a>
					      	</div>
					      </li>
					...
					<div class="wrap">
						<div class="content-top-grid">
							<div class="content-top-grid-header">
								...
								<p>eMinphis is dedicated and improve to provide a better health portal. it is light, flexible and easy to use for all medical personnel.</p>
